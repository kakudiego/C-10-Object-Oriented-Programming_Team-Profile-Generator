...
// I dont fully understand whats happing here
// lots of google for this part
// I will need more time to read the docs and more examples to fully master this part

const path = require('path');
const fs = require('fs');

// location of all the individual html
